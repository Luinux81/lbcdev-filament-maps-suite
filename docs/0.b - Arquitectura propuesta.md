...
- [ ] Crear repo principal `lbcdev-filament-maps-suite`
- [ ] Renombrar `livewire-lbcdev-component-map` → `livewire-maps-core`
- [ ] Crear repo `map-geometries`
- [ ] Renombrar (opcional) `filament-lbcdev-map-field` → `filament-maps-fields`
- [ ] Crear repo `filament-maps-widgets`
- [ ] Configurar Git submodules
- [ ] Crear DevContainer
...
- 📢 Crea un hilo en Twitter sobre tu progreso
- 📢 Comparte en Filament Discord
